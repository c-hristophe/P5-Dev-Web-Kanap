 ...
 let gestionArticlepars = JSON.parse(gestionArticle); 
             ...
             for (let i in gestionArticlepars) {
                ...
                let objcolor = gestionArticlepars[i]['color'];
                 ...
                 let qteTotal = Number(objQte) + Number(qteOld);
                 localStorage.setItem('qteTotal',qteTotal);
            ...
            //  localStorage.setItem("obj",newArrayStr);
             ...
             let qteTotal = localStorage.getItem('qteTotal');
             let qteOld = localStorage.getItem('qteOld')
                 
             const index = gestionArticlepars.findIndex(
                  (gestionArticlepars) => gestionArticlepars.nom == objTitle && gestionArticlepars.color == objcolor
                );
                 gestionArticlepars[index] = {
                 nom: objTitle,
                 qte: qteTotal,
                 color: objcolor
                }
